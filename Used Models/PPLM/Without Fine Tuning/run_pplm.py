...
def run_pplm_example(
    ...
    fop = open("/content/drive/MyDrive/PPLM/output_pplm.csv", 'a')
    fop.write('\n')
    fop.write(str(tokenizer.decode(tokenized_cond_text)))
    fop.write(':::')
    ...
    if verbosity_level >= REGULAR:
      databyte = "=" * 80
      fop.write(str(databyte))
      print("=" * 80)
    print("= Unperturbed generated text =")
    print(unpert_gen_text)
    fop.write(str(unpert_gen_text))
    fop.write(':::')
    #print()
